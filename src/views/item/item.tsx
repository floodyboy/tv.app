        ...
        <div className="relative w-screen h-screen">
          ...
          {data?.item && (
            <div className="absolute flex p-4 bottom-0 left-0 right-0 bg-black bg-opacity-70">
              ...
              {trailer ? (
                <Button icon="videocam" onClick={handleOnTrailerClick} className="text-yellow-600">
                  Трейлер
                </Button>
              ) : (
                <div />
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-wrap py-2">
                  {map(data?.item?.genres, (genre) => (
                    <Link
                      ...
                      className="border-2 border-gray-200 rounded-xl px-2 mr-2 mb-2"
                    >
                      {genre.title}
                    </Link>
                  ))}
              ...
              {data?.item?.plot && (
                <div className="py-2">
                  ...
                  <Text className="pl-2">{data?.item?.plot}</Text>
                </div>
              )}
